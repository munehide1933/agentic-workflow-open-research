...
| `S3_DRAFT_READY` | `S4_AUDIT_READY` | second-pass eligible | high-risk or eligible domains |
| `S3_DRAFT_READY` | `S5_FINAL_READY` | second-pass not required | direct finalize path |
...
## 4. Forbidden Transitions (Examples)
